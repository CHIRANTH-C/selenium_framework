...
class TestExampleOne:
    def test_login(self):
        ...
        enter_text_in_element(self.driver, txt_box_username, data[1]['txt_box_username'])
        enter_text_in_element(self.driver, txt_box_password, data[1]['txt_box_password'])
        click_element(self.driver, btn_login)
        take_screenshot(self.driver,"test_pytest_2.png")
